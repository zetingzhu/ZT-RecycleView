...
//            ((FooterLoadingLayout) mLoadMoreFooterLayout).setLoadingStr(loadingStr);
//        } else if (getFooterLoadingLayout() instanceof FooterLoadingLayout) {
//            ((FooterLoadingLayout) getFooterLoadingLayout()).setLoadingStr(loadingStr);
//        }
    }
}
