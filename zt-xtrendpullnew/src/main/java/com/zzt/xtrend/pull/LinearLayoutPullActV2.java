...
public class LinearLayoutPullActV2 extends AppCompatActivity {

    PullToRefreshLinearLayoutV2 rullll_layout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_linear_layout_pull_v2);
