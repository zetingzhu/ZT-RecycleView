...
public class HorizontalItemDecoration extends RecyclerView.ItemDecoration {
  ...
  public HorizontalItemDecoration(Map<Integer, Drawable> dividerViewTypeMap, Drawable firstDrawable,
  ...
  public static class Builder {
    ...
    public HorizontalItemDecoration create() {
      return new HorizontalItemDecoration(mDividerViewTypeMap, mFirstDrawable, mLastDrawable);
    }
  }
}
