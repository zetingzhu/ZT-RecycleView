...
import com.example.zzt.recycleview.refresh.v2.nestedOverScrollLayoutV2
...
class ActRecycleViewV13 : AppCompatActivity() {
    lateinit var oversv_list: nestedOverScrollLayoutV2
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_act_recycle_view_v13)
        initView()
    ...
    fun initViewParent() {
        rv_list.apply {
            ...
            layoutManager = LinearLayoutManager(this@ActRecycleViewV13)
            //添加自定义分割线
