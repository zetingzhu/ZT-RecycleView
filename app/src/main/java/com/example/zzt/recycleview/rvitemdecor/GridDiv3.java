 ...
 */
public class GridDiv3 extends RecyclerView.ItemDecoration {
     ...
     * @param context
     */
    public GridDiv3(Context context, Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder setmSpace(int dimenId) {
            this.mSpace = dimenId;
            return this;
        }
         ...
         */
        public GridDiv3 create(Context context) {
            return new GridDiv3(context, this);
        }
    }
