...
public class GridDivV4 extends RecyclerView.ItemDecoration {
     ...
     */
    public GridDivV4(int spacing, boolean includeEdge) {
     ...
     */
    public GridDivV4 setStartFrom(int startFromSize) {
     ...
     */
    public GridDivV4 setEndFromSize(int endFromSize) {
     ...
     */
    public GridDivV4 setNoShowSpace(int startFromSize, int endFromSize) {
        this.mStartFromSize = startFromSize;
        this.mEndFromSize = endFromSize;
        return this;
    }
