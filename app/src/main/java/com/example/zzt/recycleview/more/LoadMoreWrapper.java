package com.example.zzt.recycleview.more;
...
public class LoadMoreWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final int TYPE_FOOTER_END = 3;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        } else if (viewType == TYPE_FOOTER_END) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.layout_loading_footer_end, parent, false);
            return new LoadMoreViewHolder(view);
        } else {
