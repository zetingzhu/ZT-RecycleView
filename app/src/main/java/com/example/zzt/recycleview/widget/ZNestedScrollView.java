 ...
 */
public class ZNestedScrollView extends FrameLayout implements NestedScrollingParent3,
        NestedScrollingChild3, ScrollingView {
    static final int ANIMATED_SCROLL_GAP = 250;

    static final float MAX_SCROLL_FACTOR = 0.5f;

    private static final String TAG = "ZNestedScrollView";
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(@NonNull ZNestedScrollView v, int scrollX, int scrollY,
    ...
    public ZNestedScrollView(@NonNull Context context) {
        this(context, null);
    }

    public ZNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public boolean hasNestedScrollingParent(int type) {
        Log.d(TAG, ">> hasNestedScrollingParent:    type:" + type);
    ...
    private void onNestedScrollInternal(int dyUnconsumed, int type, @Nullable int[] consumed) {
        ...
        Log.d(TAG, ">> onNestedScrollInternal :    dyUnconsumed:" + dyUnconsumed + " type:" + type + " consumed:" + Arrays.toString(consumed));
    ...
    public boolean onInterceptTouchEvent(@NonNull MotionEvent ev) {
        ...
        Log.w(TAG, ">> onInterceptTouchEvent mIsBeingDragged:" + mIsBeingDragged);
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    Log.w(TAG, ">> dispatchNestedPreScroll Move:   deltaY:" + deltaY);
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final ZNestedScrollView nsvHost = (ZNestedScrollView) host;
